...
export default function About() {
  ...
  return (
    <div
      className="h-screen flex flex-col md:flex-row items-center justify-center bg-white text-black px-6 md:px-16 py-12 md:py-20"
      id="about"
    >
      <div className="w-full md:w-3/6 flex flex-col items-center md:items-start text-center md:text-left animate-fadeIn">
        ...
        <p className="text-lg md:text-2xl mt-6 p-4 border border-gray-300 rounded-lg shadow-lg bg-gray-100 w-full">
      ...
      <div className="hidden md:ms-7 md:h-full md:flex md:w-3/6 justify-center items-center rounded-2xl animate-slideIn">
        <img
          src={about_me}
          className="h-auto sho-2xl max-w-full object-contain rounded-3xl shadow-2xl shadow-black"
          alt="Me"
        />
      </div>
    </div>
